...
Whole dataset p-value is: `r format(round(res$p.value, 20), nsmall = 20)` 

&nbsp; 

10% dataset p-value is: `r res_2$p.value` 
...
Whole dataset confidence interval is: `r percent(tci$normal)` 

&nbsp; 

10% dataset confidence interval is: `r percent(tci2$normal)` 
...
Whole dataset confidence interval is: `r percent(rci$normal)` 

&nbsp;

10% dataset confidence interval is: `r percent(rci2$normal)` 
...
Whole dataset confidence interval for the non-random data is: `r percent(tci$normal)` 

&nbsp; 

10% dataset confidence interval for the non-random data is is: `r percent(tci2$normal)` 
